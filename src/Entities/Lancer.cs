...
{
    public class Lancer : Hero
    {
        public Lancer(string Name, int Level, string HeroType, string Weapon) : base(Name, Level, HeroType, Weapon)
        {
            this.Name = Name;
            this.Level = Level;
        ...
        public override void Attack()
        {
            ...
            if (choice == 'Y')
            {
                Console.WriteLine($"{this.Name} used the skill: 'pierce' with your {this.Weapon}!");
